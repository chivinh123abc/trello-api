...
export const errorHandlingMiddleware = (err, req, res, next) => {
  ...
  const responseError = {
    ...
    //Stack là khối dữ liệu chỉ ra vị trí lỗi của code
    stack: err.stack
  }
  // console.error(responseError)

  // Chỉ khi môi trường là DEV thì mới trả về Stack Trace để debug dễ dàng hơn, còn không thì xóa đi. video-55
